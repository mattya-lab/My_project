...
void CheckTotalTable(Statement* stmt)
{
    ...
    while (res->next())
    {
        ...
        cout << "color = " << sjis_str << ", ";
        //cout << "color = " << res->getString("colour") << ", ";
        ...
        sjis_str = utf8_to_sjis(utf8_str);
        cout << "type1 = " << sjis_str << ", ";
        //cout << "type1 = " << res->getString("type1") << ",";

        utf8_str = res->getString("type2");
        sjis_str = utf8_to_sjis(utf8_str);
        cout << "type2 = " << sjis_str << endl;
        //cout << "type2 = " << res->getString("type2") << endl;
